...
public class TestController {
    ...
    public String postForDevelopment(@PathVariable("postId") String postId, Model model)
    {
        /**
         * TODO
         ...
         */
        Member samplePost = SampleDataInit.createNewMember(); // ID : 0
        model.addAttribute("post", samplePost);
        return "post";
    }
}
